...
function page() {
    // Mock videolar (keyin API orqali backend’dan olib kelasiz)
    ...
    return (
        <div className="min-h-screen px-6 pt-30 pb-10 bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white">
            ...
            <div className="flex justify-between items-center mb-8">
                <h1 className="text-3xl font-bold">🎥 Video darslar</h1>
                <button className="px-4 py-2 bg-blue-600 hover:bg-blue-500 rounded-lg shadow-md">
